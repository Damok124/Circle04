...
/*   Updated: 2022/12/20 16:21:37 by zharzi           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ft_thinking(t_philo *philo)
{
	...
	// 	time_min = philo->context.rest_time;
	// else
	// 	time_min = philo->context.meal_time;
	if (/*philo->context.life_time > ((philo->context.meal_time \
		+ philo->context.rest_time) * 1.03) && */!ft_is_full_or_dead(philo))
	{
		ft_print_msg(philo, "is thinking");
		// ft_usleep(philo, time_min / 2);
	}
}
...
//	body_count = 1;
	...
	//while (body_count != (philo->context.members + 0))////
	//{
	i = 0;
